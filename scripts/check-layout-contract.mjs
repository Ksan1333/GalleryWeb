...
const contracts = [
  ...
  [app.includes('navigationKey="all"') && app.includes("kinds={ALL_MEDIA_KINDS}") && folderActivity.includes('"all" | "images"'), "all-media folder browser includes every catalog media kind"],
