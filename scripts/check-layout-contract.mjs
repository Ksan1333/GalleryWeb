...
const contracts = [
  ...
  [viewerCss.includes(".is-collapsed:not(.placement-floating)") && viewerCss.includes("--info-space: 54px") && viewerCss.includes("--rail-space: 54px"), "docked minimized panels reserve edge bars"],
