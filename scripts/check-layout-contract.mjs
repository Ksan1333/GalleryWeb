...
const contracts = [
  ...
  [viewerCss.includes(".is-collapsed:not(.placement-floating)") && viewerCss.includes("--info-space: 0px") && viewerCss.includes("--rail-space: 0px"), "closed docked panels release all media space"],
  [mediaViewer.includes('aria-label="ビュワーパネル"') && mediaViewer.includes('aria-label="一覧パネル"') && mediaViewer.includes('aria-label="レコメンドパネル"') && mediaViewer.includes("aria-controls="), "viewer footer offers labeled keyboard-accessible panel toggles"],
  [mediaViewer.includes("function ViewerPanelDropPreview") && mediaViewer.includes("return createPortal(") && viewerCss.includes(".pv-viewer-panel-drop-preview.target-top"), "both movable panels share a destination preview outside the old panel"],
